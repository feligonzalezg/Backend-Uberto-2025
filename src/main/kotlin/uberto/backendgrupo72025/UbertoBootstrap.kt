...
class UbertoBootstrap(
    ...
    // VIAJEROS
    val viajero1 = Viajero( 0,"Juan", "Pérez", 28, "juanp", "pass123", 123456789, false, "", 1500.50, mutableListOf())
    val viajero2 = Viajero( 0,"María", "González", 34, "mariag", "secure456", 987654321, false, "", 2300.75, mutableListOf())
    val viajero3 = Viajero(0,"Carlos", "López", 23, "carlosl", "mypwd789", 456789123, false, "", 800.25, mutableListOf())
    val viajero4 = Viajero(0,"Ana", "Martínez", 41, "anam", "password1", 321654987, false, "",3500.00, mutableListOf())
    ...
    // VEHICULOS
    final val vehiculoSimple = Vehiculo(0,"Toyota", "Corolla", "ABC123", 2018)
    final val vehiculoEjecutivo = Vehiculo(0,"Ford", "Focus", "DEF456", 2020)
    final val vehiculoMoto = Vehiculo(0,"Yamaha", "FZ25", "MNO345", 2022)
    ...
    // CONDUCTORES
    val conductor1 = Simple(0,"Luis", "Fernández", 35, "luisf", "pass1234", 111222333, true, "", vehiculoSimple, 400.0)
    val conductor2 = Ejecutivo(0,"Elena", "Ramírez", 29, "elenaR", "secure789", 444555666, true, "", vehiculoEjecutivo, 600.0)
    val conductor3 = Moto(0,"Pedro", "Sánchez", 40, "pedros", "mypass567", 777888999, true, "", vehiculoMoto, 300.0)
